// API pour récupérer les coins de l'utilisateur connecté
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    try {
      console.log('🔍 Début de la requête pour récupérer les coins utilisateur');
      ...
      console.log('💰 Coins actuels:', user.coins || 0);
