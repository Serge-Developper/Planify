  ...
  <header class="odoo-navbar">
    <div class="odoo-navbar-inner">
      ...
      <div class="odoo-navbar-bottom" v-if="!isMobile || !showMobileMenu">
        <nav class="odoo-menu">
          <a class="odoo-menu-link active" href="#">Accueil</a>
          <a class="odoo-menu-link" @click.prevent="goToEmploi">Emplois du temps</a>
          <a class="odoo-menu-link" href="#">À propos</a>
          <a class="odoo-menu-link" href="#">Contactez-nous</a>
        </nav>
      ...
      <transition name="slide-fade">
        <div v-if="isMobile && showMobileMenu" class="mobile-menu">
          ...
          <nav class="mobile-menu-links">
            ...
            <a class="odoo-menu-link" @click="goToEmploi">Emplois du temps</a>
            <a class="odoo-menu-link" href="#">À propos</a>
            <a class="odoo-menu-link" href="#">Contactez-nous</a>
            <button v-if="!isLoggedIn" class="odoo-login-btn" @click="router.push('/login')">Se connecter</button>
            <button v-else class="odoo-login-btn" @click="logout">Déconnexion</button>
...
.odoo-menu-link.active, .odoo-menu-link:hover {
  background: #5fffa1;
  color: #fff;
}
.odoo-navbar-actions {
