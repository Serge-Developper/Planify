<template>
  <div class="secret-questions-overlay">
    <div class="secret-questions-popup">
      <button class="close-btn close-btn--top-right" @click="() => { hoverCloseSecret = false; close() }" @mouseover="hoverCloseSecret = true" @mouseleave="hoverCloseSecret = false">
        <img :src="hoverCloseSecret ? closeHoverImg : closeImg" alt="Fermer" class="close-img" />
      </button>
...
const hoverCloseSecret = ref(false);
...
.close-btn.close-btn--top-right { position: absolute !important; top: 12px !important; right: 16px !important; width: 40px !important; height: 40px !important; background: transparent !important; border: none !important; box-shadow: none !important; }



.close-btn:hover { background: transparent !important; }
...
@media (max-width: 1024px) {
  .secret-questions-popup {
    ...
    padding: 60px 16px 24px 16px !important; /* Plus d'espace en haut */
  ...
  .secret-questions-popup .close-btn {
    top: 12px !important;
  ...
  .secret-questions-popup .close-img { width: 32px; height: 32px; display:block; filter: grayscale(0.5) brightness(0.95); transition: transform 0.25s, filter 0.25s; }
  .secret-questions-popup .close-btn:hover .close-img { transform: scale(1.18); filter: grayscale(0) brightness(1.1); }
}
.question-row {
  margin-bottom: 18px;
  text-align: left;
