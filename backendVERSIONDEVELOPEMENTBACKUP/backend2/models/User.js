...
const userSchema = new mongoose.Schema({
  ...
  // Persistance des variantes d'items dynamiques (ex: Discord/Jojo)
   dynamicItemVariants: { type: Map, of: Number, default: () => new Map() },
  myItems: { type: [mongoose.Schema.Types.Mixed], default: [] },
  suggestEditorState: { type: mongoose.Schema.Types.Mixed, default: null },

  // Préférences de notifications push (désactivées par défaut)
  pushPreferences: {
  ...
  proposalBlockedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
  proposalBlockedAt: { type: Date, default: null },
  proposalBlockedReason: { type: String, default: '' },
