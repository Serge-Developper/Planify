        ...
        <div class="contact-grid">
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <small class="promo-hint">(Ex: Deuxième année, MMI, Création numérique)</small>
                </div>
              </div>
              <div class="form-group">
          ...
          <div class="contact-info-column">
            ...
            <ul class="contact-info-list">
              ...
              <li>
                <img src="@/assets/img/youtube_black_logo_icon.svg" alt="YouTube" class="contact-icon">
...
.about-hero-bg {
  ...
  background-image: url('@/assets/iutscaled.webp');
...
.youtube-link:hover .external-link-arrow {
...
/* Thème sombre: texte blanc partout, sauf 2 lignes en gris */
[data-theme="dark"] .contact-main {
  background: var(--bg);
  color: #ffffff;
}
[data-theme="dark"] .contact-form-column .contact-lead {
  color: var(--muted-text); /* garder le paragraphe d’intro en gris */
}
[data-theme="dark"] .contact-info-list li div p {
  color: var(--muted-text); /* garder l’adresse en gris */
}

/* Assurer le blanc pour les éléments du contact non stylés explicitement */
[data-theme="dark"] .contact-info-column h5,
[data-theme="dark"] .contact-info-list li span,
[data-theme="dark"] label,
[data-theme="dark"] .contact-main small {
  color: #ffffff;
}

/* Exception: la note d’exemple (small) doit être en gris en sombre */
[data-theme="dark"] .contact-main .form-group small.promo-hint {
  color: var(--muted-text) !important;
}

/* Lien YouTube "Planify" en blanc en sombre */
[data-theme="dark"] .youtube-link {
  color: #ffffff;
}

/* Thème sombre: icônes de contact en blanc */
[data-theme="dark"] .contact-icon {
  filter: brightness(0) invert(1) !important;
}

/* Fallback: flèche inline au cas où currentColor ne suffirait pas */
[data-theme="dark"] .contact-info-column .external-link-arrow {
