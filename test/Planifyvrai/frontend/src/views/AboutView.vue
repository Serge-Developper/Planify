      ...
      <div class="about-container">
        ...
        <div class="about-team-row">
          <div class="about-team-member">
            <img src="@/assets/img/Serge.jpg" alt="Serge TOVMASSIAN" class="about-team-img" />
            <div>
              <h3>Serge TOVMASSIAN</h3>
              <p class="about-team-role">CEO & Développeur Web</p>
              <p>Fondateur et visionnaire en chef, Serge est le moteur de l'entreprise. Il aime rester occupé en participant au développement des stratégies logicielles, marketing et d'expérience client.</p>
            </div>
          </div>
          <div class="about-team-member">
            <img src="@/assets/img/Maxime.jpg" alt="Maxime TEBANI" class="about-team-img" />
            <div>
              <h3>Maxime TEBANI</h3>
              <p class="about-team-role">CEO & Graphiste, UI/UX Design</p>
              <p>Maxime adore relever des défis. Fort de son expérience de plusieurs années en tant que directeur commercial, il a aidé l'entreprise à en arriver là où elle en est aujourd'hui.</p>
            </div>
          </div>
        </div>
      </div>
...
.about-hero-bg {
  ...
  background-image: url('@/assets/iutscaled.jpg'); /* Image de l'IUT */
