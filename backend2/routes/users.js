...
router.get('/dynamic-item-variants', async (_req, res) => {
  // Endpoint public et tolérant: retourne toujours 200
  try {
...
router.post('/dynamic-item-variants', async (_req, res) => {
  // Tolérant: on répond 200 même si non connecté ou échec d'écriture
