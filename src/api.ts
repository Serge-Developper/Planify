// Configuration sécurisée de l'API (par défaut: domaine courant Netlify)
export const API_URL = (import.meta.env.VITE_API_URL as string) || `${window.location.origin}/api`;
