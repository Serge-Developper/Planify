    ...
    <div class="shop-modal">
      ...
      <div v-if="activeTab === 'leaderboard' && showLeaderboardTab" class="leaderboard-container">
        ...
        <div v-if="leaderboardFilter === 'factions'" class="factions-leaderboard">
          ...
          <!-- Sélecteur de faction (mobile uniquement) -->
          <div class="mobile-faction-select" v-if="isMobile">
            <label for="mobileFactionSelect" class="mobile-faction-label">Voir la faction</label>
            <select
              id="mobileFactionSelect"
              v-model="selectedFactionMobile"
              @change="onMobileFactionChange"
              class="mobile-faction-select-input"
              aria-label="Sélection de faction"
            >
          ...
          <div class="factions-columns">
            <!-- Colonne Bagnat -->
            <div class="faction-column" ref="bagnatColumnRef">
            ...
            <!-- Colonne Fermier -->
            <div class="faction-column" ref="fermierColumnRef">
...
function updateFactionTimer() {
  ...
  // Libellé de période (mois courant)
